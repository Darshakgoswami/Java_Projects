...
<head>
  ...
  <style>
    ...
    .auth-ca
    rd { background: #fff; border-radius: 12px; padding: 30px; box-shadow: 0px 4px 15px rgba(0,0,0,0.1); }
        ...
        <div class="auth-card">
          ...
          <form action="insert" method="post" enctype="multipart/form-data" autocomplete="off">
            <div class="mb-3 input-group">
              ...
              <input type="text" class="form-control" placeholder="Full Name" required name="username" autocomplete="off">
            </div>
            <div class="mb-3 input-group">
            ...
            <div class="mb-3 input-group">
              ...
              <input type="text" class="form-control" placeholder="Phone Number" required name="phone" autocomplete="off">
            </div>
            <div class="mb-3 input-group">
